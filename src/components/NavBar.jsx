    ...
    <AppBar sx={{ position: 'relative' }}>
      <Toolbar>
        ...
        <Toolbar sx={{ px: '1rem', width: '100%' }}>
          <Link to="/" style={{ color: 'inherit', padding: '1rem', textDecoration:"none" }}>Home</Link>
          <Link to="/history" style={{ color: 'inherit', padding: '1rem', textDecoration:"none"  }}>History</Link>
        </Toolbar>
      </Toolbar>
    </AppBar>
  )
